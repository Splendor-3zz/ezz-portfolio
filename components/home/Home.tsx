...
I hold a Bachelor’s degree in Software Engineering and have completed a Frontend Engineer course on Udemy. I am seeking opportunities in teams that value practical problem-solving, code quality, and continuous improvement.`
  return (
    <div className="flex flex-col justify-center items-center bg-emerald-600 mt-18">
        ...
        <div className="text-start w-full space-y-6 px-10 pb-20">
            <div className="text-center space-y-3">
                <h1 className="text-4xl">Ezzaldeen Al-shaibani</h1>
                <h2 className="text-2xl">Full-Stack Developer</h2>
            </div>
            <p className="text-l sm:px-10 md:px-30">{about}</p>
            <div className="flex justify-center gap-x-2">
                <Button className="bg-emerald-950 hover:bg-emerald-900 cursor-pointer">
                    View My work
                </Button>
                <Button className="bg-white hover:bg-emerald-200 text-emerald-950 cursor-pointer">
                    Get in Touch
                </Button>
            </div>
        </div>
