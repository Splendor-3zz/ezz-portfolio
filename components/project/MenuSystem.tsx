...
const MenuSystem = () => {
  ...
  return (
    <div className="text-white pb-20 pt-30 bg-emerald-600 px-5 sm:px-30">
      ...
      <div className="my-10">
        <h1 className="border-b w-fit text-lg sm:text-3xl mb-5">About the project :</h1>
        <p className="text-sm">{p}</p>
      </div>

      <div className="md:flex w-full space-x-10 space-y-10 md:space-y-0">
        <div className="flex flex-col gap-2 pl-5 py-5 shadow-sm border-2 w-full rounded bg-white text-emerald-800">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg sm:text-xl">Key Features</h1>
          </div>
          <div className="flex items-center gap-3">
            <GoDotFill className="text-l" />
            <h1 className="w-[85%] text-xs sm:text-sm">
          ...
          <div className="flex items-center gap-3">
            <GoDotFill className="text-l" />
            <h1 className="w-[85%] text-xs sm:text-sm">Responsive customer-facing menu</h1>
          </div>
          <div className="flex items-center gap-3">
            <GoDotFill className="text-l" />
            <h1 className="w-[85%] text-xs sm:text-sm">
        ...
        <div className="flex flex-col gap-2 pl-5 py-5 shadow-sm border-2 w-full rounded bg-white text-emerald-800">
          ...
          <div className="flex items-center gap-3">
            <GoDotFill className="text-l" />
            <h1 className="w-[85%] text-xs sm:text-sm">Frontend: React, Next.js, TypeScript</h1>
          </div>
          <div className="flex items-center gap-3">
            <GoDotFill className="text-l" />
            <h1 className="w-[85%] text-xs sm:text-sm">Backend: Next.js API routes</h1>
          </div>
          <div className="flex items-center gap-3">
            <GoDotFill className="text-l" />
            <h1 className="w-[85%] text-xs sm:text-sm">Database: MongoDB</h1>
          </div>
          <div className="flex items-center gap-3">
            <GoDotFill className="text-l" />
            <h1 className="w-[85%] text-xs sm:text-sm">ORM: Prisma</h1>
          </div>
          <div className="flex items-center gap-3">
            <GoDotFill className="text-l" />
            <h1 className="w-[85%] text-xs sm:text-sm">
              State & Data Handling: Server-side rendering and API-driven updates
            </h1>
          </div>
        </div>
      </div>
        <div className="mt-10 space-y-5">
            <h1 className="border-b w-fit text-lg sm:text-3xl">Links:</h1>
