...
const HeaderTwo = () => {
  return (
    <div className="fixed z-20 flex justify-between w-full p-3 bg-black top-0">
      <Link
        className="text-white flex items-center p-1 hover:text-white hover:bg-emerald-950 border border-emerald-900 w-fit rounded-md"
        href={"/"}
      >
        <IoIosArrowRoundBack />
        <h1 className="text-sm sm:text-l">home page</h1>
      </Link>
      <Link className="text-white flex justify-center items-center gap-3" href={"/"}>
